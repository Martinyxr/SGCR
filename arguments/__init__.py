...
class OptimizationParams(ParamGroup):
    def __init__(self, parser):
        ...
        self.scaling_lr = 0.0  # 0.005
        self.rotation_lr = 0.0   # 0.001
        self.percent_dense = 0.0   # 0.01
        self.lambda_dssim = 0.2     # 0.2
        self.lambda_consis = 2        # 2
        self.lambda_sparsity = 0.01          # 0.01
        self.final_prune_opacity = 0.5      # 0.5
